...
function getBrandsForLocation(city, base24k, base22k, base18k, mangalDirect, kalyanDirect, lalithaDirect, malabarDirect) {
  const allBrands = {
    ...
    kalyan: {
      ...
      gold24k: kalyanDirect ? kalyanDirect.gold24k : null,
      gold22k: kalyanDirect ? kalyanDirect.gold22k : null,
      gold18k: kalyanDirect ? kalyanDirect.gold18k : null,
      premium: kalyanDirect ? (kalyanDirect.gold22k - base22k) : null,
